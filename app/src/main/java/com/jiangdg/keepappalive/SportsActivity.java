...
import com.jiangdg.keepappalive.utils.MPermissionHelper;
...
public class SportsActivity extends AppCompatActivity implements MPermissionHelper.PermissionCallBack,ActivityCompat.OnRequestPermissionsResultCallback {
...
//            startActivity(intent);
    ...
    private void initView() {
        ...
        mTvRunTime.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SportsActivity.this,TwoActivity.class);
                startActivity(intent);
            }
        });
